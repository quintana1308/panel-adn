...
if (ElementPricipalHeat && ElementPricipalHeat.getAttribute('data-value')) {
    try {
        ...
        if (graficaPricipalHeat.statusGrafic === 1) {

            let idGrafic = document.getElementById('graficaPricipalHeat_id');
        ...
        console.error(`Error al generar el gráfico Heat: ${error.message}`);
    }
}